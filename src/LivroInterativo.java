...
public class LivroInterativo {
    public static void main(String[] args) {
        ...
        if (iniciar == 1) {
            // Capítulo 1
            Capitulo capitulo1 = new Capitulo("CAPÍTULO 1 - A resiliência de Diana",
                    ...
                    new String[] { "Proteger o aldeão", "Continuar lutando" }, personaDiana, 0);
            ...
            Capitulo capitulo2 = new Capitulo("CAPÍTULO 2 - O destino do bebê",
                    ...
                    new String[] { "Tentar salvar o bebê", "Ficar imóvel para o gelo não quebrar" }, personaDiana, 30);
